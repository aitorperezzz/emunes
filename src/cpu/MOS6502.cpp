...
namespace cpu
{
    /// The stack occupies the second page of the RAM
    ...
    bool MOS6502::run()
    {
        ...
        while (true)
        {
            ...
            opcode = opcode_parser.parse(mmio->get(pc));
    ...
    {
        mmio->set((uint16_t)STACK_OFFSET + sp, value);
        sp--;
    }
    ...
    {
        sp++;
        return mmio->get((uint16_t)STACK_OFFSET + sp);
    }
